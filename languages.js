...
const translations = {
  ...
  tr: {
    ...
    hobbies: "Hobiler",
    hobbies_text: "Basketbol, Filmler, Diziler ve antu peux me modifier ce code pour ajouter le mode invité ime, Okuma, Video oyunları.",
